...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
	   <div class="noprint"> <b> Para imprimir o demonstrativo, </b> <a href="javascript:window.print()">Clique aqui</a>.
               <hr></div>
        <div id="holeimg">
          <img src="imagens/f1_2ben.jpg"> </img>
            <?php
              if (isset($_GET['codcal'])) {
                ...
                /* -- CUSTOS -- */              
                if (($b["TIPEVE"] == 4) && (($b["CRTEVE"] == "49Z") || ($b["CRTEVE"] == "39Z"))){
                  if ($pulalinha == 0)
                    $ptopcus = 702;
                  
                  echo "<a style=\"position: absolute; top: " . $ptopcus . "px; left: 9px;\">" . $b["CODEVE"] . "</a>";
                  echo "<a style=\"position: absolute; top: " . $ptopcus . "px; left: 40px;\">" . acentuacaook($b["DESEVE"]) . "</a>";
                  echo "<a style=\"position: absolute; top: " . $ptopcus . "px; left: 448px; float: right; width: 50px; text-align: right;\">" . AjustaZerado($b["VALEVE"]) . "</a>";    
                  $totbenef += $b["VALEVE"];
                  $ptopcus += 12;
                  $pulalinha = 1;                 
                }                     
                ...
                echo "<a style=\"position: absolute; top: " . 838 . "px; left: 317px;\">" . acentuacaook("Total Beneficios") . "</a>";
                echo "<a style=\"position: absolute; top: " . 838 . "px; left: 448px; float: right; width: 50px; text-align: right;\">" . AjustaZerado($totbenef) . "</a>";                       
                echo "<a style=\"position: absolute; top: " . 852 . "px; left: 237px;\">" . acentuacaook("Total (Total Liquido + Beneficios)") . "</a>";
                echo "<a style=\"position: absolute; top: " . 852 . "px; left: 448px; float: right; width: 50px; text-align: right;\">" . AjustaZerado($totbenef + $valliq) . "</a>";                       
